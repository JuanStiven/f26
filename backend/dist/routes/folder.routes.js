...
router.get('/', auth_middleware_1.authenticate, auth_middleware_1.requireAdmin, folderController.getAll);
// Listar archivos físicos en una ruta específica
router.get('/files', auth_middleware_1.authenticate, auth_middleware_1.requireAdmin, folderController.listFiles);
// Crear carpeta
router.post('/', auth_middleware_1.authenticate, auth_middleware_1.requireAdmin, folderController.create);
// Renombrar carpeta
