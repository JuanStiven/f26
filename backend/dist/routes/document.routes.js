...
router.get('/', auth_middleware_1.authenticate, auth_middleware_1.requireAdmin, documentController.getAll);
// Obtener historial del empleado logueado
router.get('/history', auth_middleware_1.authenticate, auth_middleware_1.requireEmployee, documentController.getHistory);
// Obtener documento por ID
router.get('/:id', auth_middleware_1.authenticate, auth_middleware_1.requireEmployee, documentController.getById);
